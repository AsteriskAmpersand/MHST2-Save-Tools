...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fixSave = QtWidgets.QPushButton(self.centralwidget)
        self.fixSave.setObjectName("fixSave")
        self.horizontalLayout_3.addWidget(self.fixSave)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fixSave.setText(_translate("MainWindow", "Fix Save"))
